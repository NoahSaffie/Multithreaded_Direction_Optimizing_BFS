  ...
  if(file!=NULL)
    {
      ...
      if(posix_memalign((void **)&tmp_beg_pos, getpagesize(), sizeof(file_index_t)*(vert_count+1)))
	{
      ...
      if(sizeof(file_index_t)!=sizeof(new_index_t))
        {
          if(posix_memalign((void **)&beg_pos, getpagesize(), sizeof(new_index_t)*(vert_count+1)))
	    {
	      perror("posix_memalign");
	    }
  ...
  if(file!=NULL)
    {
      ...
      if(posix_memalign((void **)&tmp_csr,getpagesize(), sizeof(file_vert_t)*edge_count))
	{
	  perror("posix_memalign");
	}
      ...
      if(sizeof(file_vert_t)!=sizeof(new_vert_t))
        {
          if(posix_memalign((void **)&csr,getpagesize(), sizeof(new_vert_t)*edge_count))
	    {
	      perror("posix_memalign");
	    }
  ...
  if(file!=NULL)
    {
      ...
      if(posix_memalign((void **)&tmp_weight,getpagesize(), sizeof(file_weight_t)*edge_count))
	{
	  perror("posix_memalign");
	}
      ...
      if(sizeof(file_weight_t)!=sizeof(new_weight_t))
        {
          if(posix_memalign((void **)&weight,getpagesize(), sizeof(new_weight_t)*edge_count))
	    {
	      perror("posix_memalign");
	    }
          for(new_index_t i=0;i<edge_count;++i)
